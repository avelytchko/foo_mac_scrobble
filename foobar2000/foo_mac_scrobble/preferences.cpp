...
// Sample preferences interface: two meaningless configuration settings accessible through a preferences page and one
// accessible through advanced preferences.
...
static constexpr GUID guid_cfg_bogoSetting2 = {
    0x752f1186, 0x9f61, 0x4f91, {0xb3, 0xee, 0x2f, 0x25, 0xb1, 0x24, 0x83, 0x5d}};
...
static constexpr GUID guid_advconfig_branch = {
    0x28564ced, 0x4abf, 0x4f0c, {0xa4, 0x43, 0x98, 0xda, 0x88, 0xe2, 0xcd, 0x39}};
// This GUID identifies our Advanced Preferences setting (replace with your own when reusing code) as well as this
// setting's storage within our component's configuration file.
static constexpr GUID guid_cfg_bogoSetting3 = {
    0xf7008963, 0xed60, 0x4084, {0xa8, 0x5d, 0xd1, 0xcd, 0xc5, 0x51, 0x22, 0xca}};
...
// defaults
constexpr int default_cfg_bogo1 = 1337, default_cfg_bogo2 = 666, default_cfg_bogo3 = 42;
...
{ // accessed also from Mac specific code hence not static
cfg_uint cfg_bogoSetting1(guid_cfg_bogoSetting1, default_cfg_bogo1),
    cfg_bogoSetting2(guid_cfg_bogoSetting2, default_cfg_bogo2);
}
using namespace foo_sample;

static advconfig_branch_factory g_advconfigBranch("Sample Component", guid_advconfig_branch,
                                                  advconfig_branch::guid_branch_tools, 0);
static advconfig_integer_factory cfg_bogoSetting3("Bogo setting 3", "foo_sample.bogo3", guid_cfg_bogoSetting3,
                                                  guid_advconfig_branch, order_bogo3, default_cfg_bogo3,
                                                  0 /*minimum value*/, 9999 /*maximum value*/);
static advconfig_string_factory cfg_bogoSetting4("Bogo setting 4", "foo_sample.bogo4", guid_cfg_bogoSetting4,
                                                 guid_advconfig_branch, order_bogo4, default_cfg_bogo4);
static advconfig_checkbox_factory cfg_bogoSetting5("Bogo setting 5", "foo_sample.bogo5", guid_cfg_bogoSetting5,
                                                   guid_advconfig_branch, order_bogo5, default_cfg_bogo5);
static advconfig_branch_factory cfg_bogoRadioBranch("Bogo radio", guid_cfg_bogoRadio, guid_advconfig_branch,
                                                    order_bogoRadio);
static advconfig_radio_factory cfg_bogoRadio1("Radio 1", "foo_sample.bogoRaidio.1", guid_cfg_bogoRadio1,
                                              guid_cfg_bogoRadio, order_bogoRadio1, true);
static advconfig_radio_factory cfg_bogoRadio2("Radio 2", "foo_sample.bogoRaidio.2", guid_cfg_bogoRadio2,
                                              guid_cfg_bogoRadio, order_bogoRadio2, false);
static advconfig_radio_factory cfg_bogoRadio3("Radio 3", "foo_sample.bogoRaidio.3", guid_cfg_bogoRadio3,
                                              guid_cfg_bogoRadio, order_bogoRadio3, false);

#ifdef _WIN32
class CMyPreferences : public CDialogImpl<CMyPreferences>, public preferences_page_instance
{
  public:
    // Constructor - invoked by preferences_page_impl helpers - don't do Create() in here, preferences_page_impl does
    // this for us
    CMyPreferences(preferences_page_callback::ptr callback) : m_callback(callback) {}

    // Note that we don't bother doing anything regarding destruction of our class.
    // The host ensures that our dialog is destroyed first, then the last reference to our preferences_page_instance
    // object is released, causing our object to be deleted.
...
void CMyPreferences::apply()
{
    ...
    OnChanged(); // our dialog content has not changed but the flags have - our currently shown values now match the
                 // settings so the apply button can be disabled
}

bool CMyPreferences::HasChanged()
{
    // returns whether our dialog content is different from the current configuration (whether the apply button should
    // be enabled or not)
