...
// strongly recommended to keep only one declaration per DLL. As for 1.1, the version numbers are used by the component
...
DECLARE_COMPONENT_VERSION("Last.fm Scrobbler", "0.1.1",
...
// Activate cfg_var downgrade functionality if enabled. Relevant only when cycling from newer FOOBAR2000_TARGET_VERSION
// to older.
